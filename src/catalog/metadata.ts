...
export function buildPackageProjection(
  ...
  return {
    metadata: {
      ...
      spiParticipantCount: manifest.record_counts.spi_participants,
      pixActiveParticipantCount: manifest.record_counts.pix_active_participants,
      pixInAdhesionCount: manifest.record_counts.pix_in_adhesion,
      crosswalkRecordCount: manifest.record_counts.catalog_crosswalk,
      sourceDate: manifest.snapshot_date,
      recordCount: manifest.record_counts.pix_active_participants,
    },
    catalogMetadata: {
